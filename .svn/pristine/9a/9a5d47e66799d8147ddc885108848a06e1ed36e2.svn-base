...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //图片在线管理配置区
        ,imageManagerUrl: "php/imageManager.php"       //图片在线管理的处理地址
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion','scrawl', 'insertvideo','attachment', 'map', 'gmap', 'highlightcode','pagebreak','template','background', '|',
        ...
        // ,toolbars:[
        //     ['fullscreen', 'source',
        //         'bold', 'italic', 'underline', 'strikethrough', 'removeformat', 'autotypeset', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', '|',
        //         'fontfamily', 'fontsize', '|',
        //         'directionalityltr', 'directionalityrtl', 'indent', '|',
        //         'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|',
        //         'link', 'unlink', '|','insertimage', 'insertvideo', 'gmap', 'horizontal', 
        //         'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
        //         'preview']
        // ]
