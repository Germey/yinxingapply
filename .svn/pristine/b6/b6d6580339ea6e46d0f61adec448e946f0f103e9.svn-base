...
class UserinfoAction extends DashboardBaseAction {
    ...
    private function _get_recommend_items() {
        ...
        $items = array(
            ...
            "userinfo_birthday" => array("display" => "出生日期", "type" => "date", "param" =>array("placeholder" => "格式：YYYY-MM-DD", )),
            "userinfo_work_from" => array("display" => "参加工作时间", ),
            "userinfo_address" => array("display" => "通讯地址", "li_class"=>"fw", "param"=>array('placeholder'=>'')),
            "userinfo_address_zipcode" => array("display" => "邮编", ),

            "userinfo_work_info" => array("display" => "主要工作经历", "type" => "group" , "param" =>array("placeholder" => "时间顺序由近及远", 
                'options' => array('time'=>array('name'=>'时间', 'class'=>'span3', 'extra_attr' => 'placeholder=""'),
                                     'detail' => array('name'=>'主要经历','type'=>'textarea', 'class'=>'span6'),
                                     ))),
            "userinfo_honor" => array("display" => "所获荣誉", "type" => "textarea", ),
            ...
            "address" => array("display" => "所在地区", "type"=>"address", "li_class" => "fw", ),
        );
